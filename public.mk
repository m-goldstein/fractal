...
SOPCINFO_FILE := D:/Classes/ECE385/final/final_project/lab8_soc.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x300
SOPC_SYSID_FLAG += --sidp=0x300
ELF_PATCH_FLAG  += --sidp 0x300

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1606797977
SOPC_SYSID_FLAG += --timestamp=1606797977
ELF_PATCH_FLAG  += --timestamp 1606797977
